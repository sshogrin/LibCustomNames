local strings = {
    ...
    LCN_MENU_README2 = "Click \"%s\" at the top of this menu for more detailed instructions on how to contact the author and get a custom name. Please use the in-game mail system for gold donations only. You won't get any replies there regarding name or icon requests!",
