local strings = {
    ...
    LCN_MENU_README2 = "Click \"%s\" at the top of this menu for more detailed instructions on how to contact the author and get a custom name. Please, only use in-game mails for gold donations. You won't get any replies there!",
